...
- Stage: new-attempt review cycle 4 remediation is complete; the branch is awaiting the final fresh review cycle 5/5.
- Review cycles: `4/5` for this new PR attempt; the prior branch's `5/5` audit record remains unchanged.
