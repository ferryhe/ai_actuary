...
- Stage: new-attempt review cycle 2 remediation is complete on a verified local diff; fresh Reviewer 1/Reviewer 2/Tester cycle 3 is next.
- Review cycles: `2/5` for this new PR attempt; the prior branch's `5/5` audit record remains unchanged.
